  ...
  return (
    <main className='main'>
      <section className='leader'>
        <img src={emilyWeber} alt='Emily Weber' className='leader__image' />
        <h1 className='leader__title'>Emily Weber</h1>
        ...
        <article className='leader__article'>
          <h2 className='leader__article-subtitle'>About Emily Weber</h2>
