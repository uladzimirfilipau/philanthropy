...
function SophieMoore() {
  return (
    <main className='main'>
      <section className='leader'>
        <img src={sophieMoore} alt='Sophie Moore' className='leader__image' />
        <h1 className='leader__title'>Sophie Moore</h1>
        ...
        <article className='leader__article'>
          <h2 className='leader__article-subtitle'>About Sophie Moore</h2>
